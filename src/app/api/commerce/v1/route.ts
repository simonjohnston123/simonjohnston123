  ...
  return NextResponse.json(
    {
      ...
      endpoints: [
        { method: "GET", path: "/api/commerce/v1/destinations", purpose: "Countries we hold stock for, with product counts." },
        {
          ...
          query: {
            ...
            maxWeightKg: "heaviest acceptable, in kg",
            hasBarcode: "true for items with a real GTIN/EAN",
            page: "1-based",
            pageSize: "up to 60",
          },
        },
      ...
      agentNotes: [
        ...
        "Each product carries an `attributes` object (weight, dimensions, barcode, brand, colour, dispatch time, category tree). Absent keys mean unknown — do not infer them.",
      ],
    },
