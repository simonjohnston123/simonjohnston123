      ...
      {code ? (
        <div className="mt-6 rounded-xl border border-green-200 bg-green-50 p-5">
          ...
          <p className="mt-1 text-sm text-green-700">
            ...
            been removed from Placid Connect.
          </p>
        </div>
      ) : null}

      <div className="mt-8 space-y-4 text-sm leading-relaxed">
        <p>You can delete the data Placid Connect holds about you in any of these ways:</p>
        <ul className="list-disc space-y-2 pl-5">
          <li>
            <strong>Disconnect an integration</strong> — in your Placid Connect dashboard, open{" "}
          ...
          <li>
            <strong>Remove the app from Facebook/Instagram</strong> — in your Meta account settings, remove the Placid Connect
